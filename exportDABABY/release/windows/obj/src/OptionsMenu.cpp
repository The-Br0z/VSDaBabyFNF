...
HX_LOCAL_STACK_FRAME(_hx_pos_b7c1b117f8362d86_62_create,"OptionsMenu","create",0x9c60a34d,"OptionsMenu.create","OptionsMenu.hx",62,0x7ae6dae1)
...
HX_LOCAL_STACK_FRAME(_hx_pos_b7c1b117f8362d86_96_truncateFloat,"OptionsMenu","truncateFloat",0x5ea4e525,"OptionsMenu.truncateFloat","OptionsMenu.hx",96,0x7ae6dae1)
...
HXLINE(  94)		this->isCat = false;
HXLINE(  55)		this->currentDescription = HX_("",00,00,00,00);
...
HXLINE(  30)		 ::AccuracyDOption _hx_tmp4 =  ::AccuracyDOption_obj::__alloc( HX_CTX ,HX_("Change how accuracy is calculated. (Accurate = Simple, Complex = Milisecond Based)",8a,fa,fc,fc));
...
HXLINE(  35)		 ::SongPositionOption _hx_tmp6 =  ::SongPositionOption_obj::__alloc( HX_CTX ,HX_("Show the songs current position (as a bar)",37,bf,46,18));
HXLINE(  36)		 ::DownscrollOption _hx_tmp7 =  ::DownscrollOption_obj::__alloc( HX_CTX ,HX_("Change the layout of the strumline.",32,91,e6,a0));
HXLINE(  38)		 ::RainbowFPSOption _hx_tmp8 =  ::RainbowFPSOption_obj::__alloc( HX_CTX ,HX_("Make the FPS Counter Rainbow (Only works with the FPS Counter toggeled on)",5f,c5,d2,21));
HXLINE(  40)		 ::AccuracyOption _hx_tmp9 =  ::AccuracyOption_obj::__alloc( HX_CTX ,HX_("Display accuracy information.",0b,46,c5,44));
HXLINE(  34)		 ::OptionCatagory _hx_tmp10 =  ::OptionCatagory_obj::__alloc( HX_CTX ,HX_("Appearence",80,a4,f2,39),::Array_obj< ::Dynamic>::__new(5)->init(0,_hx_tmp6)->init(1,_hx_tmp7)->init(2,_hx_tmp8)->init(3,_hx_tmp9)->init(4, ::NPSDisplayOption_obj::__alloc( HX_CTX ,HX_("Shows your current Notes Per Second.",0e,4d,64,b3))));
HXLINE(  46)		 ::FPSOption _hx_tmp11 =  ::FPSOption_obj::__alloc( HX_CTX ,HX_("Toggle the FPS Counter",ea,68,c5,9e));
HXLINE(  47)		 ::ReplayOption _hx_tmp12 =  ::ReplayOption_obj::__alloc( HX_CTX ,HX_("View replays",d1,8a,98,ae));
HXLINE(  22)		this->options = ::Array_obj< ::Dynamic>::__new(3)->init(0,_hx_tmp5)->init(1,_hx_tmp10)->init(2, ::OptionCatagory_obj::__alloc( HX_CTX ,HX_("Misc",0c,7f,35,33),::Array_obj< ::Dynamic>::__new(3)->init(0,_hx_tmp11)->init(1,_hx_tmp12)->init(2, ::WatermarkOption_obj::__alloc( HX_CTX ,HX_("Turn off all watermarks from the engine.",85,98,13,ff)))));
...
void OptionsMenu_obj::create(){
            	HX_GC_STACKFRAME(&_hx_pos_b7c1b117f8362d86_62_create)
HXLINE(  63)		 ::flixel::FlxSprite menuBG =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,null(),null(),null());
HXDLIN(  63)		::String library = null();
HXDLIN(  63)		 ::flixel::FlxSprite menuBG1 = menuBG->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("menuDesat",26,91,04,72)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library),null(),null(),null(),null(),null());
HXLINE(  65)		menuBG1->set_color(-1412611);
HXLINE(  66)		menuBG1->setGraphicSize(::Std_obj::_hx_int((menuBG1->get_width() * ((Float)1.1))),null());
HXLINE(  67)		menuBG1->updateHitbox();
HXLINE(  68)		menuBG1->screenCenter(null());
HXLINE(  69)		menuBG1->set_antialiasing(true);
HXLINE(  70)		this->add(menuBG1);
HXLINE(  72)		this->grpControls =  ::flixel::group::FlxTypedGroup_obj::__alloc( HX_CTX ,null());
HXLINE(  73)		this->add(this->grpControls);
HXLINE(  75)		{
HXLINE(  75)			int _g = 0;
...
HXLINE(  77)				 ::Alphabet controlLabel =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(((70 * i) + 30)) ),this->options->__get(i).StaticCast<  ::OptionCatagory >()->getName(),true,false);
HXLINE(  78)				controlLabel->isMenuItem = true;
HXLINE(  79)				controlLabel->targetY = ( (Float)(i) );
HXLINE(  80)				this->grpControls->add(controlLabel).StaticCast<  ::Alphabet >();
            			}
            		}
HXLINE(  84)		this->currentDescription = HX_("none",b8,12,0a,49);
HXLINE(  86)		int _hx_tmp = (::flixel::FlxG_obj::height - 18);
HXDLIN(  86)		::String _hx_tmp1 = ((HX_("Offset (Left, Right): ",e9,11,cb,c4) + ::Std_obj::string( ::Dynamic(::flixel::FlxG_obj::save->data->__Field(HX_("offset",93,97,3f,60),::hx::paccDynamic)))) + HX_(" - Description - ",ca,32,1d,cd));
HXDLIN(  86)		::OptionsMenu_obj::versionShit =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,5,_hx_tmp,0,(_hx_tmp1 + this->currentDescription),12,null());
HXLINE(  87)		::OptionsMenu_obj::versionShit->scrollFactor->set(null(),null());
HXLINE(  88)		::OptionsMenu_obj::versionShit->setFormat(HX_("VCR OSD Mono",be,44,e4,b8),16,-1,HX_("left",07,08,b0,47),::flixel::text::FlxTextBorderStyle_obj::OUTLINE_dyn(),-16777216,null());
HXLINE(  89)		this->add(::OptionsMenu_obj::versionShit);
...
HXDLIN( 162)				::String _hx_tmp1 = ((HX_("Offset (Left, Right, Shift for slow): ",bf,2c,df,41) + ::OptionsMenu_obj::truncateFloat(( (Float)(::flixel::FlxG_obj::save->data->__Field(HX_("offset",93,97,3f,60),::hx::paccDynamic)) ),2)) + HX_(" - Description - ",ca,32,1d,cd));
...
HXDLIN( 179)			::String _hx_tmp1 = ((HX_("Offset (Left, Right, Shift for slow): ",bf,2c,df,41) + ::OptionsMenu_obj::truncateFloat(( (Float)(::flixel::FlxG_obj::save->data->__Field(HX_("offset",93,97,3f,60),::hx::paccDynamic)) ),2)) + HX_(" - Description - ",ca,32,1d,cd));
...
HXLINE( 236)			this->currentDescription = HX_("Please select a catagory",a7,91,67,83);
            		}
HXLINE( 237)		 ::flixel::text::FlxText _hx_tmp2 = ::OptionsMenu_obj::versionShit;
HXDLIN( 237)		::String _hx_tmp3 = ((HX_("Offset (Left, Right, Shift for slow): ",bf,2c,df,41) + ::OptionsMenu_obj::truncateFloat(( (Float)(::flixel::FlxG_obj::save->data->__Field(HX_("offset",93,97,3f,60),::hx::paccDynamic)) ),2)) + HX_(" - Description - ",ca,32,1d,cd));
...
Float OptionsMenu_obj::truncateFloat(Float number,int precision){
            	HX_STACKFRAME(&_hx_pos_b7c1b117f8362d86_96_truncateFloat)
HXLINE(  97)		Float num = number;
HXLINE(  98)		num = (num * ::Math_obj::pow(( (Float)(10) ),( (Float)(precision) )));
HXLINE(  99)		num = (( (Float)(::Math_obj::round(num)) ) / ::Math_obj::pow(( (Float)(10) ),( (Float)(precision) )));
HXLINE( 100)		return num;
            	}
