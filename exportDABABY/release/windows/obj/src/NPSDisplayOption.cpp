...
HX_DEFINE_STACK_FRAME(_hx_pos_94908c72a49529df_360_new,"NPSDisplayOption","new",0x0195d6b8,"NPSDisplayOption.new","Options.hx",360,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_94908c72a49529df_366_press,"NPSDisplayOption","press",0x231a9fdb,"NPSDisplayOption.press","Options.hx",366,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_94908c72a49529df_374_updateDisplay,"NPSDisplayOption","updateDisplay",0xf172f391,"NPSDisplayOption.updateDisplay","Options.hx",374,0x9d9a0240)

void NPSDisplayOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_94908c72a49529df_360_new)
HXLINE( 361)		super::__construct();
HXLINE( 362)		this->description = desc;
            	}
...
bool NPSDisplayOption_obj::press(){
            	HX_STACKFRAME(&_hx_pos_94908c72a49529df_366_press)
HXLINE( 367)		::flixel::FlxG_obj::save->data->__SetField(HX_("npsDisplay",51,08,e2,23),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("npsDisplay",51,08,e2,23),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE( 368)		this->display = this->updateDisplay();
HXLINE( 369)		return true;
            	}


::String NPSDisplayOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_94908c72a49529df_374_updateDisplay)
HXDLIN( 374)		::String _hx_tmp;
HXDLIN( 374)		if (!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("npsDisplay",51,08,e2,23),::hx::paccDynamic)) ))) {
HXDLIN( 374)			_hx_tmp = HX_("off",6f,93,54,00);
            		}
            		else {
HXDLIN( 374)			_hx_tmp = HX_("on",1f,61,00,00);
            		}
HXDLIN( 374)		return (HX_("NPS Display ",ed,73,73,03) + _hx_tmp);
            	}
