...
HX_DEFINE_STACK_FRAME(_hx_pos_1637001de69262c2_381_new,"ReplayOption","new",0x7094b10e,"ReplayOption.new","Options.hx",381,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_1637001de69262c2_387_press,"ReplayOption","press",0x73453bb1,"ReplayOption.press","Options.hx",387,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_1637001de69262c2_395_updateDisplay,"ReplayOption","updateDisplay",0xfbfe5567,"ReplayOption.updateDisplay","Options.hx",395,0x9d9a0240)

void ReplayOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_1637001de69262c2_381_new)
...
bool ReplayOption_obj::press(){
            	HX_GC_STACKFRAME(&_hx_pos_1637001de69262c2_387_press)
HXLINE( 388)		::haxe::Log_obj::trace(HX_("switch",f4,49,79,c5),::hx::SourceInfo(HX_("source/Options.hx",34,ca,fe,29),388,HX_("ReplayOption",1c,d2,4f,b9),HX_("press",83,53,88,c8)));
HXLINE( 389)		{
HXLINE( 389)			 ::flixel::FlxState nextState =  ::LoadReplayState_obj::__alloc( HX_CTX ,null(),null());
...
::String ReplayOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_1637001de69262c2_395_updateDisplay)
HXDLIN( 395)		return HX_("Load replays",92,1b,40,79);
            	}
