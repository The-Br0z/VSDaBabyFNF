...
HXLINE( 394)			goto _hx_goto_0;
            		...
            		if (  (_hx_switch_0==HX_("da-baby",66,57,19,31)) ){
HXLINE( 499)			::String tex1 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("dababy",53,33,9f,16)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),HX_("shared",a5,5e,2b,1d));
HXDLIN( 499)			tex = ::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(tex1,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("dababy",53,33,9f,16)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),HX_("shared",a5,5e,2b,1d)));
HXLINE( 500)			this->set_frames(tex);
HXLINE( 501)			this->animation->addByPrefix(HX_("idle",14,a7,b3,45),HX_("Dad idle dance",80,2a,95,5c),24,null(),null(),null());
HXLINE( 502)			this->animation->addByPrefix(HX_("singUP",6a,52,21,b9),HX_("Dad Sing Note UP",91,e8,1d,0c),24,null(),null(),null());
HXLINE( 503)			this->animation->addByPrefix(HX_("singRIGHT",0d,6f,70,ac),HX_("Dad Sing Note RIGHT",46,eb,bc,9e),24,null(),null(),null());
HXLINE( 504)			this->animation->addByPrefix(HX_("singDOWN",31,2a,ad,36),HX_("Dad Sing Note DOWN",18,d8,98,b2),24,null(),null(),null());
HXLINE( 505)			this->animation->addByPrefix(HX_("singLEFT",d6,39,ef,3b),HX_("Dad Sing Note LEFT",bd,e7,da,b7),24,null(),null(),null());
HXLINE( 507)			this->addOffset(HX_("idle",14,a7,b3,45),null(),null());
HXLINE( 508)			this->addOffset(HX_("singUP",6a,52,21,b9),-6,50);
HXLINE( 509)			this->addOffset(HX_("singRIGHT",0d,6f,70,ac),0,27);
HXLINE( 510)			this->addOffset(HX_("singLEFT",d6,39,ef,3b),-10,10);
HXLINE( 511)			this->addOffset(HX_("singDOWN",31,2a,ad,36),0,-30);
