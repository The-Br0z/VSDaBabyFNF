...
HX_DEFINE_STACK_FRAME(_hx_pos_524d86a494ed656f_104_new,"DownscrollOption","new",0xc6fce9d6,"DownscrollOption.new","Options.hx",104,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_524d86a494ed656f_110_press,"DownscrollOption","press",0x5ec33679,"DownscrollOption.press","Options.hx",110,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_524d86a494ed656f_118_updateDisplay,"DownscrollOption","updateDisplay",0xb9a0582f,"DownscrollOption.updateDisplay","Options.hx",118,0x9d9a0240)

void DownscrollOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_524d86a494ed656f_104_new)
HXLINE( 105)		super::__construct();
HXLINE( 106)		this->description = desc;
            	}
...
bool DownscrollOption_obj::press(){
            	HX_STACKFRAME(&_hx_pos_524d86a494ed656f_110_press)
HXLINE( 111)		::flixel::FlxG_obj::save->data->__SetField(HX_("downscroll",ef,45,d4,4f),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("downscroll",ef,45,d4,4f),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE( 112)		this->display = this->updateDisplay();
HXLINE( 113)		return true;
            	}


::String DownscrollOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_524d86a494ed656f_118_updateDisplay)
HXDLIN( 118)		if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("downscroll",ef,45,d4,4f),::hx::paccDynamic)) )) {
HXDLIN( 118)			return HX_("Downscroll",0f,4a,85,46);
            		}
            		else {
HXDLIN( 118)			return HX_("Upscroll",c8,b0,88,76);
            		}
