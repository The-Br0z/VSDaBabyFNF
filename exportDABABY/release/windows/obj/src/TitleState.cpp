...
HXDLIN( 317)						::String _hx_tmp1 = ((HX_("outdated lmao! ",46,1a,a2,c7) + ::StringTools_obj::trim(data)) + HX_(" != ",84,13,40,15));
HXDLIN( 317)						_hx_tmp((_hx_tmp1 + ::MainMenuState_obj::kadeEngineVer),::hx::SourceInfo(HX_("source/TitleState.hx",71,4f,0c,46),317,HX_("TitleState",79,8d,a1,8c),HX_("update",09,86,05,87)));
HXLINE( 318)						::OutdatedSubState_obj::needVer = data;
HXLINE( 319)						{
HXLINE( 319)							 ::flixel::FlxState nextState =  ::OutdatedSubState_obj::__alloc( HX_CTX ,null(),null());
...
HXLINE( 323)						 ::flixel::FlxState nextState =  ::MainMenuState_obj::__alloc( HX_CTX ,null(),null());
...
HXLINE( 328)					::haxe::Log_obj::trace((HX_("error: ",6e,80,0a,ea) + error),::hx::SourceInfo(HX_("source/TitleState.hx",71,4f,0c,46),328,HX_("TitleState",79,8d,a1,8c),HX_("update",09,86,05,87)));
HXLINE( 329)					{
...
HXLINE( 327)				http->onError =  ::Dynamic(new _hx_Closure_1());
HXLINE( 332)				http->request(null());
            			}
            			HX_END_LOCAL_FUNC1((void))
...
HXLINE( 338)			_hx_tmp2 = !(this->skippedIntro);
            		}
            		else {
...
HXLINE( 350)			 ::Alphabet money =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(0) ),textArray->__get(i),true,false);
...
HXLINE( 360)		 ::Alphabet coolText =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(0) ),text,true,false);
...
HXLINE( 380)		this->logoBl->animation->play(HX_("bump",f6,0f,20,41),null(),null(),null());
...
HXLINE( 390)		switch((int)(this->curBeat)){
            			case (int)1: {
HXLINE( 393)				this->createCoolText(::Array_obj< ::String >::fromData( _hx_array_data_8ca18d79_20,4));
            			}
            			break;
            			case (int)3: {
HXLINE( 396)				this->addMoreText(HX_("present",fb,3a,dc,39));
            			}
            			break;
            			case (int)4: {
HXLINE( 400)				this->deleteCoolText();
            			...
            			break;
            			case (int)5: {
HXLINE( 405)				if (::Main_obj::watermarks) {
HXLINE( 406)					this->createCoolText(::Array_obj< ::String >::fromData( _hx_array_data_8ca18d79_21,2));
            				}
            				else {
HXLINE( 408)					this->createCoolText(::Array_obj< ::String >::fromData( _hx_array_data_8ca18d79_22,2));
            				}
            			}
            			break;
            			case (int)7: {
HXLINE( 410)				if (::Main_obj::watermarks) {
HXLINE( 411)					this->addMoreText(HX_("KadeDeveloper",93,41,22,2c));
            				}
            				else {
HXLINE( 414)					this->addMoreText(HX_("Newgrounds",cc,13,58,ed));
HXLINE( 415)					this->ngSpr->set_visible(true);
            				}
            			}
            			break;
            			case (int)8: {
...
HXLINE( 420)				this->ngSpr->set_visible(false);
            			...
            			break;
            			case (int)9: {
HXLINE( 426)				this->createCoolText(::Array_obj< ::String >::__new(1)->init(0,this->curWacky->__get(0)));
            			}
            			break;
            			case (int)11: {
HXLINE( 429)				this->addMoreText(this->curWacky->__get(1));
            			}
            			break;
            			case (int)12: {
...
HXLINE( 440)				this->addMoreText(HX_("Night",b8,29,f7,2e));
            			...
            			break;
            			case (int)15: {
HXLINE( 443)				this->addMoreText(HX_("Funkin",51,26,e4,a3));
            			}
            			break;
            			case (int)16: {
