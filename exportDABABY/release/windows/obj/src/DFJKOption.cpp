...
HX_DEFINE_STACK_FRAME(_hx_pos_c83b011b1ca270a7_77_new,"DFJKOption","new",0xfb5a698a,"DFJKOption.new","Options.hx",77,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_c83b011b1ca270a7_83_press,"DFJKOption","press",0x85470b2d,"DFJKOption.press","Options.hx",83,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_c83b011b1ca270a7_97_updateDisplay,"DFJKOption","updateDisplay",0xd7d600e3,"DFJKOption.updateDisplay","Options.hx",97,0x9d9a0240)

void DFJKOption_obj::__construct( ::Controls controls){
            	HX_STACKFRAME(&_hx_pos_c83b011b1ca270a7_77_new)
HXLINE(  78)		super::__construct();
HXLINE(  79)		this->controls = controls;
            	}
...
bool DFJKOption_obj::press(){
            	HX_STACKFRAME(&_hx_pos_c83b011b1ca270a7_83_press)
HXLINE(  84)		::flixel::FlxG_obj::save->data->__SetField(HX_("dfjk",c3,18,67,42),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("dfjk",c3,18,67,42),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE(  86)		if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("dfjk",c3,18,67,42),::hx::paccDynamic)) )) {
HXLINE(  87)			this->controls->setKeyboardScheme(::KeyboardScheme_obj::Solo_dyn(),true);
            		}
            		else {
HXLINE(  89)			this->controls->setKeyboardScheme(::KeyboardScheme_obj::Duo(true),true);
            		}
HXLINE(  91)		this->display = this->updateDisplay();
HXLINE(  92)		return true;
            	}


::String DFJKOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_c83b011b1ca270a7_97_updateDisplay)
HXDLIN(  97)		if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("dfjk",c3,18,67,42),::hx::paccDynamic)) )) {
HXDLIN(  97)			return HX_("DFJK",c3,e0,27,2d);
            		}
            		else {
HXDLIN(  97)			return HX_("WASD",1b,2b,b3,39);
            		}
