...
HX_DEFINE_STACK_FRAME(_hx_pos_073f38f294c4fadc_125_new,"AccuracyOption","new",0x53bf62a0,"AccuracyOption.new","Options.hx",125,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_073f38f294c4fadc_130_press,"AccuracyOption","press",0x7bacf5c3,"AccuracyOption.press","Options.hx",130,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_073f38f294c4fadc_138_updateDisplay,"AccuracyOption","updateDisplay",0x7ea97179,"AccuracyOption.updateDisplay","Options.hx",138,0x9d9a0240)

void AccuracyOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_073f38f294c4fadc_125_new)
...
bool AccuracyOption_obj::press(){
            	HX_STACKFRAME(&_hx_pos_073f38f294c4fadc_130_press)
HXLINE( 131)		::flixel::FlxG_obj::save->data->__SetField(HX_("accuracyDisplay",09,75,5e,26),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("accuracyDisplay",09,75,5e,26),::hx::paccDynamic)) )),::hx::paccDynamic);
...
::String AccuracyOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_073f38f294c4fadc_138_updateDisplay)
HXDLIN( 138)		::String _hx_tmp;
HXDLIN( 138)		if (!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("accuracyDisplay",09,75,5e,26),::hx::paccDynamic)) ))) {
HXDLIN( 138)			_hx_tmp = HX_("off",6f,93,54,00);
            		}
            		else {
HXDLIN( 138)			_hx_tmp = HX_("on",1f,61,00,00);
            		}
HXDLIN( 138)		return (HX_("Accuracy ",a7,4b,73,6e) + _hx_tmp);
            	}
