...
static const ::String _hx_array_data_c96d938b_8[] = {
	HX_("EASY",02,54,cd,2d),HX_("NORMAL",27,1e,ec,e2),HX_("HARD",eb,f6,c8,2f),HX_("CRACKED",b9,d0,ef,44),
};
...
HXDLIN(   9)		difficultyArray = ::Array_obj< ::String >::fromData( _hx_array_data_c96d938b_8,4);
            	}
}
