...
HX_LOCAL_STACK_FRAME(_hx_pos_eb8a54c9c53eb75f_56_update,"HealthIcon","update",0x767ac302,"HealthIcon.update","HealthIcon.hx",56,0xf7836789)
...
HXLINE(  40)		this->animation->add(HX_("da-baby",66,57,19,31),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_23,2),0,false,isPlayer,null());
...
HXLINE(  49)			this->set_antialiasing(true);
            		...
            		_hx_goto_0:;
HXLINE(  52)		this->scrollFactor->set(null(),null());
            	}
...
void HealthIcon_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_eb8a54c9c53eb75f_56_update)
HXLINE(  57)		this->super::update(elapsed);
HXLINE(  59)		if (::hx::IsNotNull( this->sprTracker )) {
HXLINE(  60)			Float _hx_tmp = this->sprTracker->x;
HXDLIN(  60)			Float _hx_tmp1 = ((_hx_tmp + this->sprTracker->get_width()) + 10);
HXDLIN(  60)			this->setPosition(_hx_tmp1,(this->sprTracker->y - ( (Float)(30) )));
            		}
            	}
